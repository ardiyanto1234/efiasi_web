            ...
            <div class="card z-index-0" style="margin-top: -50px;">
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('login') }}">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn w-100 mt-4 mb-0" id="login-btn">{{ __('Login') }}</button>
                  </div>
                </form>
              </div>
              <div class="card-footer text-center pt-0 px-lg-2 px-1 mt-5">
                <p class="mb-4 text-sm mx-auto" id="link-reset">
                  ...
                  <a href="{{ route('register') }}" class="font-weight-bold" id="regis-btn">{{ __('Register Now?') }}</a>
                </p>
                <p class="mb-4 text-sm mx-auto" id="link-reset">
                  Forgot Your Password?
                  @if (Route::has('password.request'))
                  <a href="{{ route('password.request') }}" class="font-weight-bold" id="regis-btn">{{ __('Reset Now!') }}</a>
                  @endif
                </p>
              </div>
            </div>
